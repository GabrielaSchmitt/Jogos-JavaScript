...
document.getElementById("inicio").onclick = function start() {
    $("#inicio").hide();
	$("#backgroundGame").append("<div id='jogador' class='anima1'></div>");
	$("#backgroundGame").append("<div id='inimigo1' class='anima2'></div>");
	$("#backgroundGame").append("<div id='inimigo2'></div>");
    $("#backgroundGame").append("<div id='amigo' class='anima3'></div>");
    ...
    function placar() {
        $("#placar").html("<h2> Score: " + pontos + " Wins: " + salvos + " Losts: " + perdidos + "</h2>");
    }
	...
	function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>You got the score of: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Play again</h3></div>");
    }
